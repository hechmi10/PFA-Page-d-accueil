...
body {
  ...
  background-image: url(../css/choose-bg.jpg);
...
<img class="rounded-circle shadow avatar-sm mr-3" >
<div>
<p class="margin-auto fw-400 text-dark-75">Fallah</p>
<div class="d-flex flex-row mt-1">
<span>
<div class="svg15 double-check"></div>
</span>
...
<div class="d-flex">
<div class="w-100 d-flex pl-0">
<img class="rounded-circle shadow avatar-sm mr-3 chat-profile-picture" src="{{asset('images\layout_img\fares basdouri.jpg')}}">
<div class="mr-3">
<a href="!#">
<p class="fw-400 mb-0 text-dark-75">Fares basdouri</p>
</a>
...
<div class="chat-search pl-3 pr-3">
<div class="input-group">
<form action="{{route('Messagebackend')}}" method="post">
    @csrf
<input type="text" name="message" class="form-control" id="messageInput" placeholder="Write a message">
<div class="input-group-append prepend-white">
<span class="input-group-text pl-2 pr-2">
...
<button onclick="sendMessage()" class="btn btn-primary">Envoyer un message</button>

<!-- Ou utilisez un lien -->
<!-- <a href="#" onclick="sendMessage()" class="btn btn-primary">Envoyer un message</a> -->

<!-- Votre contenu HTML actuel -->
<!-- Vos scripts actuels -->

<!-- Ajoutez la fonction JavaScript pour envoyer un message -->
<script>

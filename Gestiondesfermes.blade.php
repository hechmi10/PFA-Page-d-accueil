      ...
      <nav class="navbar navbar-expand-lg custom_nav-container">
        ...
        <div id="myNav" class="overlay">
          ...
          <div class="overlay-content">
            ...
            <a class="" href="Marketplace.blade.php">
              Marketplace
            </a>
            <a class="" href="Gestiondesfermes.blade.php">
              Gestion des fermes
            </a>
          ...
          <a class="" href="jeudesimulation.blade.php">
            Jeu de simulation
          </a>
  ...
  <section class="choose_section layout_padding section_pl">
    <div class="container py_mobile_45">
        <div class="heading_container heading_center">
            <h2>Gestion des fermes<span></span></h2>
        </div>
        <div class="row">
            <div class="col-md-4">
                <div class="box">
              ...
              <div class="detail-box">
                <h5>Suivi des cultures</h5>
                <p>garder une trace détaillée de chaque culture pour faciliter la prise de décisions éclairées et l'optimisation des rendements agricoles.</p>
            </div>
        </div>
        <div class="btn-box">
        ...
        <div class="box_content">
            <div class="img-box">
              ...
              <div class="detail-box">
                ...
                <p>Suivez vos stocks de produits agricoles tels que les semences, les engrais, etc. Enregistrez les quantités disponibles, les dates d'achat, les fournisseurs, etc.</p>
            </div>
        </div>
        <div class="btn-box">
    ...
    <div class="box">
        <div class="box_content">
            <div class="img-box">
              ...
              <div class="detail-box">
                <h5>Planification des Récoltes</h5>
                <p>Visualisez vos récoltes prévues et planifiez vos activités.Consultez les dates de récolte prévues et organisez la main-d'œuvre et l'équipement nécessaires.</p>
            </div>
        </div>
        <div class="btn-box">
